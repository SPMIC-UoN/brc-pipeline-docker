...
if [ $CLUSTER_MODE = "YES" ] ; then
    ...
    export FSLDIR="/usr/local/fsl/6.0.7.x"
...
export BRCDIR="/usr/local/BRC_Pipeline"
...
export ANTSPATH="/usr/local/ants-2.5.3/bin"
export C3DPATH="/usr/local/c3d-1.0.0-Linux-x86_64/bin"
